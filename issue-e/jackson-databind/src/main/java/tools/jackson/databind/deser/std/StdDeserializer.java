        ...
        case JsonTokenId.ID_NULL: // null fine for non-primitive
            {
                ...
                if (res != null) { return (Boolean) res; }
            }
            return false;
...
inputDesc, _coercedTypeDesc(targetType));
     ...
     */
    protected final Object _verifyNullForPrimitive(DeserializationContext ctxt)
        throws JacksonException
    {
...
"Cannot coerce `null` to %s (disable `DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES` to allow)",
                    _coercedTypeDesc());
            return ctxt.handleUnexpectedNull(getValueType(ctxt), msg);
        }
        return null;
    }
